...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        return view('auth.register', compact('jenisKelamin', 'agama', 'tahunPelajaran', 'statusDaftar', 'kelas', 'kurikulum', 'jurusan'));
    }
    ...
    public function register(Request $request)
    {
        try {
            ...
            $data['kurikulum_id'] = Kurikulum::where('unit_sekolah_id', $kelas->unit_sekolah_id)->latest()->first()->id;

            $data['tahun_pelajaran_id'] = $tahun_pelajaran ? $tahun_pelajaran->id : null;
            Siswa::create($data);
