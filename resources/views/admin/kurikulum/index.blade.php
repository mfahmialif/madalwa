...
<div class="row">
    <div class="col-sm-12">
        <div class="alert alert-info d-flex align-items-start gap-3" role="alert">
            ...
            <div>
                <strong>Jika ingin menghapus data,</strong><br>
                Silakan hapus terlebih dahulu data berikut:<br>
                <a href="{{ route('admin.jadwal.index') }}"><strong>Jadwal</strong></a><br>
            </div>
        </div>
                                ...
                                <div class="doctor-search-blk mt-3 mt-md-0">
                                    <div class="top-nav-search table-search-blk">
                                        <form onsubmit="event.preventDefault(); searchDataTable('#tableKurikulum');">
                                            <input type="text" class="form-control" id="search-table" oninput="searchDataTable('#tableKurikulum')" placeholder="Search here">
                                            <a class="btn"><img src="{{ asset('template') }}/assets/img/icons/search-normal.svg" alt=""></a>
                                        </form>
                                    </div>
                                    <div class="add-group">
                                        <a href="{{ route('admin.kurikulum.add') }}" class="btn btn-primary add-pluss ms-2"><img src="{{ asset('template') }}/assets/img/icons/plus.svg" alt=""></a>
                                        <a href="javascript:void(0);" onclick="searchDataTable('#tableKurikulum', true)" class="btn btn-primary doctor-refresh ms-2"><img src="{{ asset('template') }}/assets/img/icons/re-fresh.svg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            if (willDelete) {
                ...
                $.ajax({
                    ...
                    , success: function(response) {
                        searchDataTable('#tableKurikulum', true);
