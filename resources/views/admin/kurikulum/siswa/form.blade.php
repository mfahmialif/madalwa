...
<div class="col-12 pb-4">
    <div class="doctor-submit text-end">
        ...
        <a href="{{ route('admin.kurikulum.siswa.index', ['kurikulum' => $kurikulum]) }}"
            class="btn btn-secondary cancel-form">Batalkan</a>
    </div>
</div>
@push('script')
    <script>
        let kurikulum = @json($kurikulum);
        ...
        function dataTable(tableId) {
            var url = "{{ route('admin.kurikulum.siswa.data-siswa', ['kurikulum' => $kurikulum]) }}"
