                                ...
                                <div class="doctor-search-blk mt-3 mt-md-0">
                                    <div class="top-nav-search table-search-blk">
                                        <form onsubmit="event.preventDefault(); searchDataTable('#tableMataPelajaran');">
                                            <input type="text" class="form-control" id="search-table" oninput="searchDataTable('#tableMataPelajaran')" placeholder="Search here">
                                    ...
                                    <div class="add-group">
                                        ...
                                        <a href="javascript:void(0);" onclick="searchDataTable('#tableMataPelajaran', true)" class="btn btn-primary doctor-refresh ms-2"><img src="{{ asset('template') }}/assets/img/icons/re-fresh.svg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
