                                    ...
                                    <div class="add-group">
                                        ...
                                        <div class="dropdown ms-2">
                                            <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                                <img src="{{ asset('template') }}/assets/img/icons/bar-icon.svg" alt="">
                                            </button>
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <li><button class="dropdown-item" onclick="changeStatusLulus()">Ganti
                                                        status:
                                                        <b>Lulus</b></button></li>
                                            </ul>
                                        </div>
...
<script>
    ...
    function dataTable(tableId) {
        var url = "{{ route('admin.kelulusan.data') }}"
    ...
    function deleteData(event) {
        ...
        swal({
            ...
            , text: "Data yang akan dikembalikan statusnya: " + nama
            , icon: "warning"
            , buttons: {
                confirm: {
                    text: "OK"
        ...
        , }).then((willDelete) => {
            if (willDelete) {
                var url = "{{ route('admin.kelulusan.destroy', ['siswa' => '_siswa']) }}";
    ...
    function changeStatusLulus() {
        ...
        $.ajax({
            type: "PUT"
            , url: "{{ route('admin.kelulusan.update-status-lulus') }}"
            , data: {
                _token: "{{ csrf_token() }}"
                , siswa_id: siswa_id
            , }
