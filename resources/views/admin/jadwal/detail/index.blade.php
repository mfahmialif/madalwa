    ...
    <div class="col-sm-12">
        ...
        <div class="alert alert-info d-flex align-items-start gap-3" role="alert">
            ...
            <div>
                ...
                Kelas: <strong>{{ $kurikulumDetail->mataPelajaran->kelas->angka ?? '-' }}
                    ({{ $kurikulumDetail->mataPelajaran->kelas->unitSekolah->nama_unit }})</strong>
            </div>
        </div>
        <div class="alert alert-info d-flex align-items-start gap-3" role="alert">
            <i class="feather-info mt-1"></i>
            <div>
                ...
                <a href="{{ route('admin.absensi.index') }}"><strong>Absensi</strong></a><br>
                <a href="{{ route('admin.nilai.index') }}"><strong>Nilai</strong></a><br>
            </div>
        </div>
                        ...
                        <div class="col">
                            <div class="doctor-table-blk">
                                ...
                                <div class="doctor-search-blk mt-3 mt-md-0">
                                    ...
                                    <div class="add-group">
                                        <a href="{{ route('admin.jadwal.detail.add', ['kurikulumDetail' => $kurikulumDetail, 'tahunPelajaran' => $tahunPelajaran]) }}" class="btn btn-primary add-pluss ms-2"><img src="{{ asset('template') }}/assets/img/icons/plus.svg" alt=""></a>
