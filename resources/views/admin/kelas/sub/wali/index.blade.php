                        ...
                        <div class="col">
                            <div class="doctor-table-blk">
                                ...
                                <div class="doctor-search-blk mt-3 mt-md-0">
                                    ...
                                    <div class="add-group">
                                        <a href="{{ route('admin.kelas.sub.wali.add', ['kelas' => $kelas, 'kelasSub' => $kelasSub]) }}" class="btn btn-primary add-pluss ms-2"><img src="{{ asset('template') }}/assets/img/icons/plus.svg" alt=""></a>
