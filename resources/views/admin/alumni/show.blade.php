...
<div class="page-header">
    <div class="row">
        <div class="col-sm-12">
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.mata-pelajaran.index') }}">Alumni</a></li>
        ...
        <div class="card card-table show-entire">
            <div class="card-body">
                            ...
                            <div class="doctor-table-blk">
                                ...
                                <div class="doctor-search-blk mt-3 mt-md-0">
                                    <div class="top-nav-search table-search-blk">
                                        <form onsubmit="event.preventDefault(); searchDataTable('#tableAlumniPetahun');">
                                            <input type="text" class="form-control" id="search-table" oninput="searchDataTable('#tableAlumniPetahun')" placeholder="Search here">
                                            <a class="btn"><img src="{{ asset('template') }}/assets/img/icons/search-normal.svg" alt=""></a>
                                        </form>
                                    </div>
                                    <div class="add-group">
                                        <a href="{{ route('admin.mata-pelajaran.add') }}" class="btn btn-primary add-pluss ms-2"><img src="{{ asset('template') }}/assets/img/icons/plus.svg" alt=""></a>
                                        <a href="javascript:void(0);" onclick="searchDataTable('#tableAlumniPetahun', true)" class="btn btn-primary doctor-refresh ms-2"><img src="{{ asset('template') }}/assets/img/icons/re-fresh.svg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table id="tableAlumniPetahun" class="table border-0 custom-table comman-table datatable mb-0 table-hover">
                        <thead>
                            <tr>
    ...
    $(document).ready(function() {
        ...
        function deleteData(event) {
            ...
            , }).then((willDelete) => {
                if (willDelete) {
                    var url =
                        "{{ route('admin.mata-pelajaran.destroy', ['mataPelajaran' => '_mataPelajaran']) }}";
