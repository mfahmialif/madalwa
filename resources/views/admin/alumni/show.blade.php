                                ...
                                <div class="doctor-table-blk">
                                    ...
                                    <div class="doctor-search-blk mt-3 mt-md-0">
                                        <div class="top-nav-search table-search-blk">
                                            <form
                                                onsubmit="event.preventDefault(); searchDataTable('#tableAlumniPetahun');">
                                                <input type="text" class="form-control" id="search-table"
                                                    oninput="searchDataTable('#tableAlumniPetahun')"
                                        ...
                                        <div class="add-group">
                                            ...
                                            <a href="javascript:void(0);"
                                                onclick="searchDataTable('#tableAlumniPetahun', true)"
