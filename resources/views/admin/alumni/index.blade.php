        ...
        <div class="card card-table show-entire">
            <div class="card-body">
                            ...
                            <div class="doctor-table-blk">
                                ...
                                <div class="doctor-search-blk mt-3 mt-md-0">
                                    <div class="top-nav-search table-search-blk">
                                        <form onsubmit="event.preventDefault(); searchDataTable('#tableAlumni');">
                                            <input type="text" class="form-control" id="search-table" oninput="searchDataTable('#tableAlumni')" placeholder="Search here">
                                            <a class="btn"><img src="{{ asset('template') }}/assets/img/icons/search-normal.svg" alt=""></a>
                                        </form>
                                    </div>
                                    <div class="add-group">
                                        <a href="{{ route('admin.kelulusan.index') }}" class="btn btn-primary add-pluss ms-2"><img src="{{ asset('template') }}/assets/img/icons/plus.svg" alt=""></a>
                                        <a href="javascript:void(0);" onclick="searchDataTable('#tableAlumni', true)" class="btn btn-primary doctor-refresh ms-2"><img src="{{ asset('template') }}/assets/img/icons/re-fresh.svg" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="table-responsive">
                    <table id="tableAlumni" class="table border-0 custom-table comman-table datatable mb-0 table-hover">
                        <thead>
                            <tr>
...
<script>
    ...
    function dataTable(tableId) {
        var url = "{{ route('admin.alumni.data') }}"
