...
@section('content')
    ...
    <div class="page-header">
        <div class="row">
            <div class="col-sm-12">
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.lembaga.index') }}">Kelembagaan</a></li>
            ...
            <div class="card bg-white">
                ...
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-bottom">
                        <li class="nav-item"><a class="nav-link active" href="#bottom-tab1" data-bs-toggle="tab">Profile</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#bottom-tab2" data-bs-toggle="tab">Alamat Lembaga</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="#bottom-tab3" data-bs-toggle="tab">Contact</a></li>
                        <li class="nav-item"><a class="nav-link" href="#bottom-tab4" data-bs-toggle="tab">Kepala Sekolah</a>
                        </li>
                    </ul>
                    <form class="mt-3" id="formLembaga" action="{{ route('admin.lembaga.store') }}" method="POST">
                        @csrf
                        <div class="tab-content">
                            <div class="tab-pane show active" id="bottom-tab1">
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="text" id="nsm" name="nsm" value="{{ $data->nsm }}"
                                            class="form-control" placeholder="Masukkan NSM">
                                    </div>
                                </div>
                                <div class="row mb-3 p-3">
                                    <label for="npsn" class="col-sm-1 col-form-label">NPSN</label>
                                    <div class="col-sm-11">
                                        <input type="text" id="npsn" name="npsn" value="{{ $data->npsn }}"
                                            class="form-control" placeholder="Masukkan NPSN">
                                    </div>
                                </div>
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="text" id="nama_sekolah" name="nama_sekolah"
                                            value="{{ $data->nama_sekolah }}" class="form-control"
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-11">
                                        <select id="jenjang" name="jenjang_sekolah" class="form-select">
                                            <option value="">Pilih Status</option>
                                            <option value="MA/SMA/SMK"
                                                {{ $data->jenjang_sekolah == 'MA/SMA/SMK' ? 'selected' : '' }}>MA/SMA/SMK
                                            </option>
                                            <option value="SMP/MTS"
                                                {{ $data->jenjang_sekolah == 'SMP/MTS' ? 'selected' : '' }}>
                                                SMP/MTS</option>
                                            <option value="SD/MI"
                                                {{ $data->jenjang_sekolah == 'SD/MI' ? 'selected' : '' }}>SD/MI
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-11">
                                        <select id="status" name="status_sekolah" class="form-select">
                                            <option value="">Pilih Status</option>
                                            <option value="Negeri"{{ $data->status_sekolah == 'Negeri' ? 'selected' : '' }}>
                                                Negeri
                                            </option>
                                            <option value="Swasta"
                                                {{ $data->status_sekolah == 'Swasta' ? 'selected' : '' }}>Swasta
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="alamat_lengkap" name="alamat_lengkap"
                                            value="{{ $data->alamat_lengkap }}" class="form-control"
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="provinsi" name="provinsi"
                                            value="{{ $data->provinsi }}" class="form-control"
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="kabupaten" name="kabupaten"
                                            value="{{ $data->kabupaten }}" class="form-control"
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="kecamatan" name="kecamatan"
                                            value="{{ $data->kecamatan }}" class="form-control"
                                ...
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="text" id="website" name="website"
                                            value="{{ $data->website }}" class="form-control"
                            ...
                            <div class="tab-pane" id="bottom-tab4">
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="text" id="kpl_madrasah" name="kpl_madrasah"
                                            value="{{ $data->kepala_madrasah }}" class="form-control"
                                            placeholder="Masukkan No Telp">
                                    </div>
                                </div>
                                <div class="row mb-3 p-3">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="text" id="nip" name="nip" value="{{ $data->nip }}"
                                            class="form-control" placeholder="Masukkan Email">
                                    </div>
                                </div>
