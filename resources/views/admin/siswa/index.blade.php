                        ...
                        <div class="col">
                            <div class="doctor-table-blk">
                                ...
                                <div class="doctor-search-blk mt-3 mt-md-0">
                                    ...
                                    <div class="add-group">
                                        <a href="{{ route('admin.pendaftaran-siswa-baru.add') }}" class="btn btn-primary add-pluss ms-2"><img src="{{ asset('template') }}/assets/img/icons/plus.svg" alt=""></a>
                                        ...
                                        <div class="dropdown ms-2">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li><button class="dropdown-item" onclick="changeStatusDaftar('{{ $item }}')">Ganti
                                                        status:
