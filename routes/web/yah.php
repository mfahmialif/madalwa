...
Route::prefix('admin')->middleware(['auth'])->group(function () {
    Route::middleware('role:admin')->group(function () {
        ...
        Route::prefix('mutasi-masuk')->group(function () {
            ...
            Route::get('/{mutasi-masuk}/edit', [MutasiMasukController::class, 'edit'])->name('admin.mutasi-masuk.edit');
            Route::put('/{mutasi-masuk}/update', [MutasiMasukController::class, 'update'])->name('admin.mutasi-masuk.update');
            Route::delete('/{mutasi-masuk}/destroy', [MutasiMasukController::class, 'destroy'])->name('admin.mutasi-masuk.destroy');
        });
        Route::prefix('mutasi-keluar')->group(function () {
            ...
            Route::get('/{mutasi-keluar}/edit', [MutasiKeluarController::class, 'edit'])->name('admin.mutasi-keluar.edit');
            Route::put('/{mutasi-keluar}/update', [MutasiKeluarController::class, 'update'])->name('admin.mutasi-keluar.update');
            Route::delete('/{mutasi-keluar}/destroy', [MutasiKeluarController::class, 'destroy'])->name('admin.mutasi-keluar.destroy');
        });
    });
});
